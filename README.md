...
- [**ai-project-split-assembly**](https://github.com/pansir-heihei/ai-project-split-assembly)（2026-08 发布）——
  本方法与《AI 项目工程化管理手册》融合后的**六阶段工程化手册**（立项→详细设计→实施→组装→竣工→运维）。
  本仓库教 AI 怎么拆怎么装；那个仓库管项目全生命周期。详细设计阶段的核心思想：施工图设计——
  按 100% 完美标准为后续每一步任务画图（执行者零思考、照图施工），并预设 5% 瑕疵处置方案。
